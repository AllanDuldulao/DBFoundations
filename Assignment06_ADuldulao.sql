--*************************************************************************--
-- Title: Assignment06
-- Author: Allan Duldulao
-- Desc: This file demonstrates how to use Views
-- Change Log: When,Who,What
-- 2025-11-15,ADuldulao,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_ADuldulao')
	 Begin 
	  Alter Database [Assignment06DB_ADuldulao] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_ADuldulao;
	 End
	Create Database Assignment06DB_ADuldulao;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_ADuldulao;
...
ON I.EmployeeID = E.EmployeeID
GROUP BY CategoryName, InventoryDate, ProductName ,[Count],EmployeeFirstName +' '+ EmployeeLastName
ORDER BY 1,3,2,4,5
GO
